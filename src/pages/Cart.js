...
<div className=" w-full md:max-w-xl">
  <img className=" " src="https://media.istockphoto.com/id/1352766190/vector/shopaholic-woman-running-with-an-empty-shopping-cart.jpg?b=1&s=612x612&w=0&k=20&c=Hla3NveEWq0AAnTlFgyMi95dEFqv_yJjPBDxBX15tFo=" alt="" />
</div>
<p className='text-center font-bold text-md md:text-lg'>Your cart is empty..!</p>
</div> 
      }
